...
const (
	...
	HelloParserSUB        = 4
	HelloParserNUMBER     = 5
	HelloParserWHITESPACE = 6
)

// HelloParser rules.
const (
	HelloParserRULE_start      = 0
	HelloParserRULE_expression = 1
)
...
func NewEmptyExpressionContext() *ExpressionContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = HelloParserRULE_expression
	return p
}
...
func (p *HelloParser) Expression() (localctx IExpressionContext) {
	return p.expression(0)
}

func (p *HelloParser) expression(_p int) (localctx IExpressionContext) {
	this := p
	_ = this
	...
	_startState := 2
	p.EnterRecursionRule(localctx, 2, HelloParserRULE_expression, _p)
	var _la int
	...
	for _alt != 2 && _alt != antlr.ATNInvalidAltNumber {
		if _alt == 1 {
			...
			case 1:
				...
				p.PushNewRecursionContext(localctx, _startState, HelloParserRULE_expression)
				p.SetState(10)
...
func (p *HelloParser) Expression_Sempred(localctx antlr.RuleContext, predIndex int) bool {
	this := p
	_ = this
